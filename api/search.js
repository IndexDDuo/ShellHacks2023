...
export default async (req, res) => {
  if (req.method === 'POST') {
    ...
    const apiUrl = `https://api.fbi.gov/@wanted?pageSize=20&page=15&sort_on=modified&sort_order=desc&title=${title}&field_offices=${formattedFieldOffices}&weight=${weight}&age_min=${age}&age_max=${age}&race=${race}`;
